...
- 单页面工作台。
- 心灵关怀模块：每日 Quote、可编辑 Quote 生成提示词、批量预生成缓存、即时刷新切换、能量自评、今日 focus、失败 fallback。
