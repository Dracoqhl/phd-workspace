...
- `components/care/CarePanel.tsx`: compact mental care card backed by `/api/care`, including local fallback daily quote content, title-row energy icons and status pill, small retry/favorite icon actions, and an editable "today focus" field.
