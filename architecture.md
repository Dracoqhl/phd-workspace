...
- `app/globals.css`: Tailwind directives, CSS variable theme definitions, semantic state tokens, compatibility overrides for existing utility classes, themed custom scrollbars, and base page styling.
